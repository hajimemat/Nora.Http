...
class Uri implements UriInterface
{
    ...
    public function getPort()
    {
        ...
        if ($this->port === 443 && $this->getScheme() === "https") {
            return null;
        }
        return $this->port;
    }
    ...
    {
        $newInstance = $this->immutable();
        $newInstance->userInfo = $user . ($password ? ":{$password}": "");
        return $newInstance;
    }
    ...
    {
        $instance = new static();
        foreach(['scheme', 'userInfo', 'host', 'port', 'path', 'query', 'fragment'] as $key)
        {
